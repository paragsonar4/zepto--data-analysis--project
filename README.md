# zepto--data-analysis--project
 # objective :
 The objective of this project is to analyze inventory and sales data using SQL to extract meaningful business insights. This project focuses on analyzing product availability, pricing, discounts, stock status, category-wise performance, and revenue trends through data analysis.

The project helps in practicing important SQL concepts such as:
...
The main goal is to transform raw business data into actionable insights that can help improve inventory management and product performance analysis in a quick-commerce environment. This project also strengthens practical SQL skills required for Data Analyst and SQL Developer roles.
...
please find the queries that i have written to solve above business problems
